...
pub static LANG_SPECS: &[LanguageSpec] = &[
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_definition"], classes: &["class_definition"], interfaces: EMPTY, properties: &["assignment"], imports: &["import_statement"], calls: &["call"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_definition", "function_declaration"], classes: &["class_declaration"], interfaces: &["interface_declaration"], properties: EMPTY, imports: &["import_statement"], calls: &["call_expression"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_declaration", "method_declaration"], classes: &["type_declaration"], interfaces: &["interface_type"], properties: EMPTY, imports: &["import_specifier"], calls: &["call_expression"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_item"], classes: &["struct_item", "enum_item", "impl_item", "trait_item"], interfaces: &["trait_item"], properties: &["field_declaration"], imports: &["use_declaration"], calls: &["call_expression"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["method_declaration"], classes: &["class_declaration"], interfaces: &["interface_declaration"], properties: &["field_declaration"], imports: &["import_declaration"], calls: &["method_invocation"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_declaration"], classes: &["class_declaration"], interfaces: &["interface_declaration"], properties: &["property_declaration"], imports: &["import"], calls: &["call_expression"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_declaration"], classes: &["class_declaration", "mixin_declaration"], interfaces: &["class_declaration"], properties: &["field_declaration"], imports: &["import"], calls: &["function_expression"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_declaration"], classes: &["class_declaration", "struct_declaration"], interfaces: &["protocol_declaration"], properties: &["property_declaration"], imports: &["import_declaration"], calls: &["call_expression"] },
    ...
    LanguageSpec {
        ...
        config_files: EMPTY,
        tier: Tier::Full,
        kinds: NodeKinds { functions: &["function_definition"], classes: &["interface_declaration", "implementation_declaration"], interfaces: EMPTY, properties: &["property_declaration"], imports: &["preproc_include"], calls: &["message_send"] },
