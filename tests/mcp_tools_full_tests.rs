...
mod mcp_core_tools {
    ...
    async fn test_mcp_init() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "mcp_init should succeed: {:?}", result.err());
        let value = result.unwrap();
        assert!(value.get("initialized").is_some() || value.as_bool() == Some(true) || !value.to_string().is_empty());
    }
    ...
    async fn test_mcp_status() {
        ...
        assert!(result.is_ok(), "mcp_status should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_mcp_index() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "mcp_index should succeed: {:?}", result.err());
    }
    ...
    async fn test_mcp_index_docs() {
        ...
        if result.is_err() {
            ...
            assert!(err.contains("not found") || err.contains("empty") || err.contains("no doc"),
                "mcp_index_docs error should be expected for empty docs: {}", err);
        }
    }
    ...
    async fn test_mcp_install() {
        ...
        assert!(result.is_ok(), "mcp_install should succeed: {:?}", result.err());
    }
    ...
    async fn test_mcp_impact() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "mcp_impact should succeed: {:?}", result.err());
    }
}
...
mod query_tools {
    ...
    async fn test_query_file() {
        let (handler, _tmp) = create_real_handler().await;
        let result = handler
            .execute_tool("query_file", &json!({"file": "./src/main.rs", "pattern": "fn"}))
            .await;
        assert!(result.is_ok(), "query_file should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("files").is_some() || value.get("results").is_some() || !value.to_string().is_empty();
    ...
    async fn test_query_file_missing_pattern() {
        let (handler, _tmp) = create_real_handler().await;
        let result = handler.execute_tool("query_file", &json!({"file": "./src/main.rs"})).await;
        assert!(result.is_err(), "query_file should error without pattern");
        assert!(result.unwrap_err().contains("pattern"), "Error should mention 'pattern'");
    }
    ...
    async fn test_search_code() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "search_code should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_search_code_missing_query() {
        ...
        assert!(result.unwrap_err().contains("query"), "Error should mention 'query'");
    }
    ...
    async fn test_find_function() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "find_function should succeed: {:?}", result.err());
        let value = result.unwrap();
...
mod dependency_tools {
    ...
    async fn test_get_dependencies() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_dependencies should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_get_dependencies_missing_file() {
        ...
        assert!(result.is_err(), "get_dependencies should error without file");
        assert!(result.unwrap_err().contains("file"), "Error should mention 'file'");
    }
    ...
    async fn test_get_dependents() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_dependents should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_get_call_graph() {
        let (handler, _tmp) = create_real_handler().await;
        let result = handler
            .execute_tool("get_call_graph", &json!({"function": "./src/main.rs::main", "depth": 1}))
            .await;
        assert!(result.is_ok(), "get_call_graph should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_get_call_graph_missing_function() {
        ...
        assert!(result.is_err(), "get_call_graph should error without function");
        assert!(result.unwrap_err().contains("function"), "Error should mention 'function'");
    }
    ...
    async fn test_get_callers() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_callers should succeed: {:?}", result.err());
        let value = result.unwrap();
        // May be empty if validate_key has no callers, but should not error
        assert!(value.get("callers").is_some() || !value.to_string().is_empty(),
    ...
    async fn test_get_callers_missing_function() {
        ...
        if result.is_err() {
            let err = result.unwrap_err();
            assert!(err.contains("function") || err.contains("name"),
...
mod impact_context_tools {
    ...
    async fn test_get_impact_radius() {
        let (handler, _tmp) = create_real_handler().await;
        let result = handler
            .execute_tool("get_impact_radius", &json!({"file": "./src/main.rs", "depth": 2}))
            .await;
        assert!(result.is_ok(), "get_impact_radius should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("impact").is_some() || value.get("affected").is_some() || !value.to_string().is_empty();
    ...
    async fn test_get_impact_radius_missing_params() {
        ...
        assert!(result.is_err(), "get_impact_radius should error without params");
    }
    ...
    async fn test_get_context() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_context should succeed: {:?}", result.err());
        let value = result.unwrap();
        ...
        assert!(!is_empty || has_obj_data, "get_context should return non-empty data");
    }
    ...
    async fn test_get_review_context() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_review_context should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("context").is_some() || value.get("review").is_some() || !value.to_string().is_empty();
    ...
    async fn test_get_review_context_missing_files() {
        ...
        assert!(result.is_err(), "get_review_context should error without files");
        assert!(result.unwrap_err().contains("files"), "Error should mention 'files'");
    }
}
...
mod documentation_tools {
    ...
    async fn test_get_doc_for_file() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_doc_for_file should succeed: {:?}", result.err());
        let value = result.unwrap();
        // May be empty if no docs linked, but should not error
        assert!(value.get("docs").is_some() || !value.to_string().is_empty(),
    ...
    async fn test_get_files_for_doc() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_files_for_doc should succeed: {:?}", result.err());
        let value = result.unwrap();
        assert!(value.get("files").is_some() || !value.to_string().is_empty(),
    ...
    async fn test_get_doc_structure() {
        ...
        assert!(result.is_ok(), "get_doc_structure should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("structure").is_some() || value.get("docs").is_some() || !value.to_string().is_empty();
    ...
    async fn test_get_doc_tree() {
        ...
        assert!(result.is_ok(), "get_doc_tree should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_generate_doc() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "generate_doc should succeed: {:?}", result.err());
        let value = result.unwrap();
        let is_empty = value.as_str().map(|s| s.is_empty()).unwrap_or(false);
        let has_obj_data = value.as_object().map(|o| !o.is_empty()).unwrap_or(false);
        assert!(!is_empty || has_obj_data, "generate_doc should return non-empty data");
    }
...
mod traceability_tools {
    ...
    async fn test_get_traceability() {
        let (handler, _tmp) = create_real_handler().await;
        let result = handler
            .execute_tool("get_traceability", &json!({"element": "./src/main.rs::main"}))
            .await;
        assert!(result.is_ok(), "get_traceability should succeed: {:?}", result.err());
        let value = result.unwrap();
        assert!(value.get("traceability").is_some() || !value.to_string().is_empty(),
    ...
    async fn test_search_by_requirement() {
        let (handler, _tmp) = create_real_handler().await;
        let result = handler
            .execute_tool("search_by_requirement", &json!({"requirement_id": "REQ-001"}))
            .await;
        // May return empty if no requirements indexed, but should not error
        assert!(result.is_ok(), "search_by_requirement should succeed: {:?}", result.err());
    }
    ...
    async fn test_get_code_tree() {
        ...
        assert!(result.is_ok(), "get_code_tree should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("tree").is_some() || value.get("code").is_some() || !value.to_string().is_empty();
    ...
    async fn test_find_related_docs() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "find_related_docs should succeed: {:?}", result.err());
        let value = result.unwrap();
        assert!(value.get("docs").is_some() || !value.to_string().is_empty(),
...
mod cluster_tools {
    ...
    async fn test_get_clusters() {
        ...
        assert!(result.is_ok(), "get_clusters should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_get_cluster_context() {
        ...
        if result.is_err() {
            let err = result.unwrap_err();
            assert!(err.contains("not found") || err.contains("Cluster"),
                "Expected cluster not found error: {}", err);
        }
    }
}
...
mod utility_tools {
    ...
    async fn test_mcp_hello() {
        ...
        assert!(result.is_ok(), "mcp_hello should succeed: {:?}", result.err());
        let value = result.unwrap();
        // mcp_hello typically returns a greeting or status
        assert!(!value.to_string().is_empty(), "mcp_hello should return data");
    }
    ...
    async fn test_get_service_graph() {
        ...
        assert!(result.is_ok(), "get_service_graph should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("services").is_some() || value.get("graph").is_some() || !value.to_string().is_empty();
    ...
    async fn test_detect_changes() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "detect_changes should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_orchestrate() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "orchestrate should succeed: {:?}", result.err());
        let value = result.unwrap();
        // Orchestrate may return complex result, just verify it returns something
        assert!(!value.to_string().is_empty(), "orchestrate should return data");
    }
    ...
    async fn test_ctx_read() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "ctx_read should succeed: {:?}", result.err());
        let value = result.unwrap();
        // ctx_read returns string content
        let is_string = value.is_string();
        assert!(is_string, "ctx_read should return string content");
        assert!(!value.as_str().unwrap_or("").is_empty(), "ctx_read should return non-empty content");
    }
    ...
    async fn test_run_raw_query() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "run_raw_query should succeed: {:?}", result.err());
        let value = result.unwrap();
...
mod analysis_tools {
    ...
    async fn test_find_large_functions() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "find_large_functions should succeed: {:?}", result.err());
        let value = result.unwrap();
    ...
    async fn test_get_tested_by() {
        ...
        let result = handler
            ...
            .await;
        assert!(result.is_ok(), "get_tested_by should succeed: {:?}", result.err());
        let value = result.unwrap();
        let has_data = value.get("tests").is_some() || value.get("tested_by").is_some() || !value.to_string().is_empty();
...
mod error_handling {
    ...
    async fn test_unknown_tool() {
        ...
        let err = result.unwrap_err();
        assert!(err.contains("Unknown") || err.contains("not found") || err.contains("Unknown tool"),
    ...
    async fn test_invalid_json_params() {
        ...
        let result = handler.execute_tool("mcp_status", &serde_json::Value::Null).await;
        // Should either succeed with defaults or fail gracefully
        if result.is_err() {
            let err = result.unwrap_err();
            assert!(err.contains("param") || err.contains("argument"),
