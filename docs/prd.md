...
> | **P0** | **DONE** | RocksDB LOCK poison — embed auto-arm blocks all DB tools — `FR-P0-EMBED-LOCK` / `REL-P0-EMBED-LOCK` ([A/B](reports/ab-leankg-vs-raw-live-2026-08-02.md), §3.29 / §5.33) |
...
> **FR checklist + status:** [`prd-task-tracker.md`](prd-task-tracker.md) — `FR-P0-EMBED-LOCK` **DONE** / `REL-P0-EMBED-LOCK` (NOT_DONE).
...
> **FR checklist + status:** [`prd-task-tracker.md`](prd-task-tracker.md) — `FR-P0-MCP-RC-01..04` **DONE** / `REL-P0-MCP-RC` (NOT_DONE).
