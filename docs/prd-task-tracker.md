...
| FR-HEA-05 | Positioning cutover — docs lead with org-memory substrate | v4.0.0 `docs/prd.md` §1 (this revision) |
...
| ID | Title | Reason |
|----|-------|--------|
| OMP-BACKEND-FORK | Replace OMP `memory.backend` via fork/patch | Closed enum in OMP; integration stays MCP-first (prd.md §1.2) |
