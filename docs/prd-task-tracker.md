...
*Last updated: 2026-09-14 (v4.11.4 vector-reclaim — `gc` reclaims orphaned vectors (#411 closed, live: 11/11 purged, `Orphans: 0` after, coverage 1.0); loop waves #401→#410 shipped as **v0.32.0** with all four tarballs; 12 defects fixed cumulatively; state: doctor 10 pass / 1 honest warn / 0 fail. Prior: v4.11.3 doctor-truth (#409/#406); v4.11.2 S1 + six defects)*
